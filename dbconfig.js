...
module.exports = {
  ...
  //connectString : process.env.NODE_ORACLEDB_CONNECTIONSTRING || "localhost/orcl"||"orcl "||"Data Source=orcl; User ID=hr; Password=93"
  connectString :"localhost/orcl"
  
  //connectString="Data Source=orcl; User ID=hr; Password=93"
